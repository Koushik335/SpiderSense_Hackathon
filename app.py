...
# ---------------------------------------------------------------------------
# High-Impact Cyberpunk UI Styling
# ---------------------------------------------------------------------------
st.markdown("""
<style>
@import url('https://fonts.googleapis.com/css2?family=Bangers&family=Space+Grotesk:wght@600;700;800&family=JetBrains+Mono:wght@400;600;700;800&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap');
...
.stApp {
    ...
    background-image: 
        radial-gradient(circle at 10% 0%, rgba(230, 36, 41, 0.15) 0%, transparent 40%),
        radial-gradient(circle at 90% 0%, rgba(0, 240, 255, 0.12) 0%, transparent 40%),
...
.stTabs [aria-selected="true"] {
    ...
    box-shadow: 0 4px 16px rgba(0, 240, 255, 0.2) !important;
}
...
/* Master Verdict Card */
.verdict-hero-card {
    background: linear-gradient(135deg, rgba(230, 36, 41, 0.12) 0%, rgba(10, 15, 30, 0.9) 100%);
    border: 2px solid #E62429;
    border-radius: 16px;
    padding: 28px;
    text-align: center;
    margin-bottom: 20px;
    box-shadow: 0 12px 35px rgba(230, 36, 41, 0.18);
}
...
div.stButton > button {
    ...
    box-shadow: 0 4px 18px rgba(230, 36, 41, 0.45) !important;
    transition: all 0.2s ease !important;
    width: 100%;
}
div.stButton > button:hover {
    transform: translateY(-2px) !important;
    box-shadow: 0 8px 25px rgba(230, 36, 41, 0.7) !important;
}
</style>
...
if not st.session_state.has_run:
    ...
    with tab2:
        st.markdown('<div class="sp-card">', unsafe_allow_html=True)
        st.markdown('<div class="sp-card-header">Specialized Domain Agents // Real-Time Telemetry</div>', unsafe_allow_html=True)
                ...
                <div class="agent-node" style="border-left: 4px solid {status_col};">
                    <div>
                        <div style="display:flex; justify-content:space-between; align-items:center;">
                            <strong style="color:#FFF; font-size:1rem;">{o.agent}</strong>
                        ...
                        <div style="font-family:'Space Grotesk'; font-size:1.45rem; font-weight:800; color:{status_col}; margin:12px 0 4px 0;">
                            {o.label}
                        </div>
                        <div style="font-family:'JetBrains Mono'; font-size:0.75rem; color:#94A3B8;">
                            CONFIDENCE // {o.confidence:.0%}
                        </div>
                        <div style="font-size:0.84rem; color:#CBD5E1; line-height:1.5; margin:12px 0; background:rgba(15,23,42,0.6); padding:10px 12px; border-radius:6px;">
                            {o.reasoning}
                        </div>
                    </div>
            ...
            with c:
                ...
                <div class="agent-node" style="border: 2px solid {'#00F0FF' if is_active else '#1E293B'}; background:{'rgba(0,240,255,0.05)' if is_active else '#080D1A'};">
                    <div>
                        ...
                        <div style="font-family:'Space Grotesk'; font-size:1.3rem; font-weight:800; color:{action_col}; margin:10px 0 6px 0;">
                            {syn2['action']}
                        </div>
